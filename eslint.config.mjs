/**
 * ESLint flat config for @pawells/graphql-workspace.
 *
...

	{
		...
		rules: {
			...
			'@typescript-eslint/naming-convention': [
				...
				{ selector: 'classProperty', format: ['PascalCase', 'UPPER_CASE'], leadingUnderscore: 'allow' },
				{
				...
				{ selector: 'typeMethod', format: ['PascalCase', 'camelCase'] },
				{ selector: 'function', format: ['PascalCase', 'UPPER_CASE'], leadingUnderscore: 'allow' },
				{ selector: 'accessor', format: ['PascalCase', 'UPPER_CASE'], leadingUnderscore: 'allow' },
				{ selector: 'import', modifiers: ['default'], format: ['camelCase', 'PascalCase'] },
				{ selector: 'variable', modifiers: ['destructured'], format: null },
				{ selector: 'variable', format: ['PascalCase', 'UPPER_CASE'], leadingUnderscore: 'allow' },
